---
title: "AI-Native 团队的「狂飙」周末：从黑客松到 MCP 管理神器 Passport，Every 正在重新定义 AI 时代的产品开发"
description: |
  在 AI 技术浪潮席卷全球的今天，一家名为 Every 的科技媒体和创作者社区，正以一种独特而激进的方式，向我们展示未来组织的可能性。他们不仅仅报道 AI，更将自己变成了 AI-First 的"原生部落"。
date: "2025-07-28"
categories: [AI, "Product Development", "Team Culture", "Hackathon", "iOS App", "MCP", "AI-First"]
image: "index_image/GwwnSlobgAEGSms.jpg"
image-alt: |
  Every Hackathon 项目列表展示，包含多个 AI 驱动项目的截图。
toc-depth: 3
---


![](./index_image/GwwnSlobgAEGSms.jpg)
...
![Every Hackathon 项目列表](./index_image/GwonKAkWQAEfRak.png)
...
![Katie Parrott 的 AI Editor 项目](./index_image/GwokQvOXgAASCW-.jpeg)
...
![Passport 应用演示 1](./index_image/x8nDA4oRTzFBQIsA.jpg)
![Passport 应用演示 2](./index_image/TF-_0emCgPXK5zDl.jpg)
...
![Dan Shipper 用梗图表达让 Claude Code 制定超天才计划时的感受](./index_image/Gw0l5xlXUAADVzw.jpeg)
...
![](./index_image/image-20250728104722470.png)
